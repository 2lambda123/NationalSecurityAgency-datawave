 ...
 * <p>
 * The use of a {@link DatawaveKey} means this projection is applicable to any
 * type of key (field index, event, tf, etc).
 */
public final class KeyProjection
    implements PeekingPredicate<Entry<Key, String>> {

  private final Projection projection;

  public KeyProjection(Set<String> projections,
  ...
  public boolean apply(Entry<Key, String> input) {
    ...
    final String fieldName =
        JexlASTHelper.removeGroupingContext(parser.getFieldName());
