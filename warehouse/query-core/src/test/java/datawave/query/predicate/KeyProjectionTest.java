...
public class KeyProjectionTest {
  ...
  public void setup() {
    ...
    fiData.add(
        Maps.immutableEntry(new Key("20200314_1", "fi\0FIELD_A"), "data"));
    fiData.add(
        Maps.immutableEntry(new Key("20200314_1", "fi\0FIELD_B"), "data"));
    fiData.add(
        Maps.immutableEntry(new Key("20200314_1", "fi\0FIELD_C"), "data"));
    fiData.add(
        Maps.immutableEntry(new Key("20200314_1", "fi\0FIELD_X"), "data"));
    fiData.add(
        Maps.immutableEntry(new Key("20200314_1", "fi\0FIELD_Y"), "data"));
    fiData.add(
        Maps.immutableEntry(new Key("20200314_1", "fi\0FIELD_Z"), "data"));

    eventData = new ArrayList<>();
    eventData.add(Maps.immutableEntry(
        new Key("20200314_1", "datatype\0uid", "FIELD_A\0value_a"), "data"));
    eventData.add(Maps.immutableEntry(
        new Key("20200314_1", "datatype\0uid", "FIELD_B\0value_b"), "data"));
    eventData.add(Maps.immutableEntry(
        new Key("20200314_1", "datatype\0uid", "FIELD_C\0value_c"), "data"));
    eventData.add(Maps.immutableEntry(
        new Key("20200314_1", "datatype\0uid", "FIELD_X\0value_x"), "data"));
    eventData.add(Maps.immutableEntry(
        new Key("20200314_1", "datatype\0uid", "FIELD_Y\0value_y"), "data"));
    eventData.add(Maps.immutableEntry(
        new Key("20200314_1", "datatype\0uid", "FIELD_Z\0value_z"), "data"));
  }
  ...
  public void testIncludes() {
    KeyProjection projection =
        new KeyProjection(Sets.newHashSet("FIELD_A", "FIELD_B"),
  ...
  public void testExcludes() {
    KeyProjection projection =
        new KeyProjection(Sets.newHashSet("FIELD_X", "FIELD_Y"),
