...
public class ProjectionTest {
  ...
  public void testNoConfiguration() {
    Projection projection =
        new Projection(null, Projection.ProjectionType.INCLUDES);
  ...
  public void testIncludesDepricated() {
    Projection projection =
        new Projection(Sets.newHashSet("FIELD_A", "FIELD_B"),
  ...
  public void testExcludesDeprecated() {
    Projection projection =
        new Projection(Sets.newHashSet("FIELD_X", "FIELD_Y"),
  ...
  public void testTheAbsurdDeprecated() {
    Projection projection = new Projection(Sets.newHashSet("PREFIX"),
                                           Projection.ProjectionType.INCLUDES);
